...
//------------------------------------------------------------------------------
TTime GetTime (void)/* __critical*/ //возвращает текущее значение счетчика
{
	TTime t;
	uint32_t ui;
	uint64_t tt;
...
uint64_t GetTimeMSec (void) //возвращает текущее значение времени в миллисекундах
{
    TTime t;
	uint64_t ui;
